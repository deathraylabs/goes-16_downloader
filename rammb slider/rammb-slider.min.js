...
function calculateDistanceBetweenXYs(e, t, r, a) {
    return Math.sqrt(Math.pow(r - e, 2) + Math.pow(a - t, 2))
}
...
function validateUrlParameters() {
    return $.each(url_parameters, function (e, t) {
        -1 !== $.inArray(e, valid_url_parameters) && void 0 !== t || delete url_parameters[e]
        ...
        -1 != $.inArray(t, [1, "1"]) ? url_parameters.hidden[e] = parseInt(t) : delete url_parameters.hidden[e]
...
getQueryStringAsObject = function () {
    ...
    for (o = function (e) {
        ...
        }; r = u.exec(c);) e = r[1].indexOf("["), s = n(r[2]), e < 0 ? i[a = n(r[1])] ? (i[a] = o(i[a]), Array.prototype.push.call(i[a], s)) : i[a] = s : (a = n(r[1].slice(0, e)), l = n(r[1].slice(e + 1, r[1].indexOf("]", e))), i[a] = o(i[a]), l ? i[a][l] = s : Array.prototype.push.call(i[a], s));
    return i
};
var default_satellite = getQueryStringAsObject().sat || json.default_satellite,
    url_parameters = {
        ...
        s: "rammb-slider",
        q: void 0,
        draw_color: json.draw_colors[json.default_draw_color].substring(1),
        draw_width: json.default_draw_width
    },
    valid_url_parameters = Object.keys(url_parameters);
valid_url_parameters.push("map");
var debug_on = !1,
    scale_in_miles = !1;
...
if (-1 !== location.hostname.indexOf(serverCheck01 + serverCheck02 + serverCheck03 + serverCheck04 + serverCheck05 + serverCheck06 + serverCheck07 + serverCheck08 + serverCheck09 + serverCheck10 + serverCheck11 + serverCheck12 + serverCheck13 + serverCheck14 + serverCheck15 + serverCheck16 + serverCheck17 + serverCheck18 + serverCheck19) || -1 !== location.hostname.indexOf(serverCheckNoaa01 + serverCheckNoaa02 + serverCheckNoaa03 + serverCheckNoaa04 + serverCheckNoaa05 + serverCheckNoaa06 + serverCheckNoaa07 + serverCheckNoaa08 + serverCheckNoaa09 + serverCheckNoaa10 + serverCheckNoaa11 + serverCheckNoaa12 + serverCheckNoaa13 + serverCheckNoaa14 + serverCheckNoaa15 + serverCheckNoaa16) || -1 !== location.hostname.indexOf("localhost")) {
    ...
    function calculateFirstLastImagePosition(e, t, r, a, o, l, s) {
        var i = Math.abs(l - o) + 1,
            n = Math.round(calculateFollowStep(e, r, i)),
            c = Math.round(calculateFollowStep(t, a, i));
        return {
            x0: e + n * (0 - o),
            y0: t + c * (0 - o),
            x1: r + n * (s - l - 1),
    ...
    function displayFollowBox(e, t, r, a) {
        a = defaultFor(a, getAbsoluteLoopingIndex());
        var o = $("<div id='followBox" + leadingZeros(r, 2) + "' class='followBox' title='Drag this box around the feature you want to follow to adjust the start/end position, centering the feature in the box.' style='left: " + (e - 11) + "px; top: " + (t - 11) + "px; width: 20px; height: 20px; border-width: 1px;'></div>");
        return o.attr("data-follow-box-number", r), o.attr("data-recent-image-number", a), $zoom_holder.append(o), isFollowBoxPositionUniqueReturnValue = isFollowBoxPositionUnique(o), !0 !== isFollowBoxPositionUniqueReturnValue ? (o.remove(), alert(isFollowBoxPositionUniqueReturnValue), !1) : ($(".followBox").draggable({
            start: function (e, t) {
            ...
            stop: function (e, t) {
                if (0 == followBoxRevert) {
                    ...
                    var a = getAbsoluteLoopingIndex();
                    $(this).attr("data-recent-image-number", a), url_parameters.follow_x[a] = convertScreenPixelsToBigPixels($(this).position().left + $(this).outerWidth() / 2), url_parameters.follow_y[a] = convertScreenPixelsToBigPixels($(this).position().top + $(this).outerHeight() / 2), updateURL(), drawFollowVector(), setFollowVectors()
                }
                followBoxRevert = !1
            }
        }), !0)
    ...
    function createArray(e) {
        ...
        if (arguments.length > 1)
            for (var a = Array.prototype.slice.call(arguments, 1); r--;) t[e - 1 - r] = createArray.apply(this, a);
        return t
    }
...
function initializeTileFilenamesArray() {
    for (var e = 0; e <= max_zoom_level; e++) {
        ...
        for (r = 0; r <= t; r++)
            for (c = 0; c <= t; c++) {
                var o = leadingZeros(r, 3),
                    l = leadingZeros(c, 3);
                tile_filenames[e][r][c][0] = a + "/" + o + "_" + l, tile_filenames[e][r][c][1] = ".z" + a + ".r" + o + ".c" + l, tile_filenames[e][r][c][2] = " z" + a + " r" + o + " c" + l
            }
    }
}

function addProductToTileArray(e, t, a, o, l, s, i, n, u, d) {
...
function addMapLatLonToTileArray(e, t, a, o, l, s, i) {
    ...
    n[1] = a, n[2] = o, n[3] = l, n[4] = s, n[5] = i, map_lat_lon_tiles[e] = n
}

function swapSelectOptions(e, t) {
    var r, a, o, l;
    o = e.val(), l = t.val(), r = e.find("option:gt( 1 )").remove(), a = t.find("option:gt( 1 )").remove(), r.appendTo(t), a.appendTo(e), e.val(l).selectmenu("refresh"), t.val(o).selectmenu("refresh")
}
...
function reverseTimesIfBackwards() {
    if (0 != url_parameters.st && 0 != url_parameters.et && url_parameters.st > url_parameters.et) {
        ...
        var t = $("#startDateSelector"),
            ...
            l = $("#startTimeSelector"),
            s = $("#endTimeSelector");
        t.length && r.length && swapSelectOptions(t, r), a.length && o.length && swapSelectOptions(a, o), l.length && s.length && swapSelectOptions(l, s)
    }
}

function updateDateSelects(e) {
    for (var t = $("#startDateSelector"), r = $("#endDateSelector"), a = -1, o = e.map(function (e) {
            var t = e.toString();
            return t.slice(0, 4) + "-" + t.slice(4, 6) + "-" + t.slice(6, 8)
        }), l = 1; l < o.length; l++)
        if (Date.parse(o[l - 1]) - Date.parse(o[l]) > 1296e5) {
            a = l;
            break
        } $.each(e, function (e, o) {
        e == a && (t.append("<option disabled='disabled'>--- Saved Case Studies ---</option>"), r.append("<option disabled='disabled'>--- Saved Case Studies ---</option>")), t.append("<option value='" + o + "'>" + convertTimestampToDisplayTime(o) + "</option>"), r.append("<option value='" + o + "'>" + convertTimestampToDisplayTime(o) + "</option>")
...
function getTimestampedMapsCartopy(e) {
    ...
    $.each(url_parameters.maps, function (r, a) {
        t && -1 != $.inArray(r, t) || "borders" == r && "off" == a || r in url_parameters.mhidden || $.ajax({
            type: "GET",
            url: server_root_maps + "json/" + url_parameters.sat + "/" + url_parameters.sec + "/maps/" + r + "/" + a + "/latest_times_all.json",
            dataType: "json",
            success: function (t) {
                var o = $("#holder-" + r);
...
function getLatestTimes(e = !1) {
    var t = server_root_2 + "json/" + url_parameters.sat + "/" + url_parameters.sec + "/" + url_parameters.p[0] + "/latest_times.json";
    (url_parameters.im - 1) * url_parameters.ts + 1 > 100 && (t = server_root_2 + "json/" + url_parameters.sat + "/" + url_parameters.sec + "/" + url_parameters.p[0] + "/latest_times_5760.json"), $.ajax({
        type: "GET",
        url: t,
        dataType: "json",
        success: function (t) {
            e && all_times && all_times[all_times.length - 1] == t.timestamps_int[0] || loadImageryTimes(t.timestamps_int)
        }
    })
}
...
function getAvailableTimes(e) {
    ...
    var l = [];
    if (0 != url_parameters.st && 0 != url_parameters.et) reverseTimesIfBackwards(), o = parseInt(url_parameters.et.toString().slice(0, 8)), a = parseInt(url_parameters.st.toString().slice(0, 8)), $.each(e, function (e, r) {
        if (r <= o && r >= a) t = getAvailableTimesForDate(r), $.each(Object.keys(t).sort().reverse(), function (e, r) {
            l = getAllAvailableTimesFromTimesNested(r, t, l, !0)
        });
        else if (r < a) return !1
    });
    else if (0 != url_parameters.et) o = parseInt(url_parameters.et.toString().slice(0, 8)), r = (url_parameters.im - 1) * url_parameters.ts + 1, $.each(e, function (e, a) {
        ...
        a = parseInt(url_parameters.st.toString().slice(0, 8)), r = (url_parameters.im - 1) * url_parameters.ts + 1, $.each(e.reverse(), function (e, o) {
            if (o >= a && (t = getAvailableTimesForDate(o), $.each(Object.keys(t).sort().reverse(), function (e, r) {
                    l = getAllAvailableTimesFromTimesNested(r, t, l, !1)
                })), l.length >= r) return !1
        })
    }
    return l
...
function getAllAvailableTimesFromTimesNested(e, t, r, a) {
    return t[e].constructor === Object ? ($.isArray(r) && (r = {}), $.each(t[e], function (e, t) {
        a ? e <= url_parameters.et && (r[e.toString()] = t) : e >= url_parameters.st && (r[e.toString()] = t)
    })) : $.each(t[e], function (e, t) {
        a ? t <= url_parameters.et && r.push(t) : t >= url_parameters.st && r.push(t)
    }), r
}

function convertNestedTimestampsIfObject(e) {
    return e[Object.keys(e)[0]].constructor !== Object ? e : ($.each(e, function (t, r) {
        e[t] = Object.keys(r), $.each(e[t], function (r, a) {
            e[t][r] = parseInt(a)
        })
    }), e)
}
...
function initializeTimeArrays(e) {
    var t = 0,
        r = 0;
    e.constructor === Object ? (all_times_flags = e, e = Object.keys(all_times_flags), $.each(e, function (t, r) {
        e[t] = parseInt(r)
    })) : (all_times_flags = {}, $("#imageryFlagMessage").length && $("#imageryFlagMessage").remove()), $.isEmptyObject(all_times_flags) || $("#imageryFlagMessage").length || $("#pluginWrapper").after("<div id='imageryFlagMessage'></div>"), setImageryFlagMessage(), all_times = [];
    var a, o, l = 0;
    if (0 != url_parameters.st && 0 != url_parameters.et)
        if (reverseTimesIfBackwards(), a = $.inArray(url_parameters.st, e), o = $.inArray(url_parameters.et, e), -1 != a && -1 != o) {
            if (1 == url_parameters.ts) all_times = e.slice(o, a + 1);
            else {
                var s = e.slice(o, a + 1);
                for (t = 0; t < s.length; t += url_parameters.ts) all_times.push(s[t])
            }
        ...
        if (-1 != (o = $.inArray(parseInt(url_parameters.et), e))) {
        ...
        if (e = e.reverse(), -1 != (a = $.inArray(url_parameters.st, e)))
    ...
    if (0 == all_times.length) {
        for (0 == e.length && getLatestTimes(), (l = (url_parameters.im - 1) * url_parameters.ts + 1) > e.length && (l = e.length), r = 0, t = 0; t < l; t += url_parameters.ts) all_times[r] = e[t], r++;
        all_times = all_times.reverse()
    }
...
function setArchiveModeState() {
    if (0 != url_parameters.st || 0 != url_parameters.et) {
        if ($("#archive").prop("checked", !0).checkboxradio("refresh"), 0 != url_parameters.st) {
            var e = url_parameters.st.toString().slice(0, 8),
                t = url_parameters.st.toString().slice(8, 10),
                r = $('#startHourSelector option:contains("' + t + '")').val();
            $("#startDateSelector").val(e).selectmenu("refresh"), r ? $("#startHourSelector").val(r).selectmenu("enable").selectmenu("refresh") : updateArchiveDropdownHours("#startHourSelector", e, "Begin", url_parameters.st), $("#startTimeSelector option[ value=" + url_parameters.st + "]").length && $("#startTimeSelector").val(url_parameters.st).selectmenu("enable").selectmenu("refresh")
        } else $("#startDateSelector").val(0).selectmenu("refresh"), $("#startHourSelector").val(0).selectmenu("refresh").selectmenu("disable"), $("#startTimeSelector").val(0).selectmenu("refresh").selectmenu("disable");
        if (0 != url_parameters.et) {
            var a = url_parameters.et.toString().slice(0, 8),
                o = url_parameters.et.toString().slice(8, 10),
                l = $('#endHourSelector option:contains("' + o + '")').val();
            $("#endDateSelector").val(url_parameters.et.toString().slice(0, 8)).selectmenu("refresh"), l ? $("#endHourSelector").val(l).selectmenu("enable").selectmenu("refresh") : updateArchiveDropdownHours("#endHourSelector", a, "End", url_parameters.et), $("#endTimeSelector option[ value=" + url_parameters.et + "]").length && $("#endTimeSelector").val(url_parameters.et).selectmenu("enable").selectmenu("refresh")
        } else $("#endDateSelector").val(0).selectmenu("refresh"), $("#endHourSelector").val(0).selectmenu("refresh").selectmenu("disable"), $("#endTimeSelector").val(0).selectmenu("refresh").selectmenu("disable");
        0 != url_parameters.st && 0 != url_parameters.et ? $("#numberOfImagesSelectorChange").selectmenu("disable") : $("#numberOfImagesSelectorChange").selectmenu("enable")
    } else $("#archive").prop("checked", !1).checkboxradio("refresh"), $("#startDateSelector").val(0).selectmenu("refresh"), $("#startHourSelector").val(0).selectmenu("refresh").selectmenu("disable"), $("#startTimeSelector").val(0).selectmenu("refresh").selectmenu("disable"), $("#endDateSelector").val(0).selectmenu("refresh"), $("#endHourSelector").val(0).selectmenu("refresh").selectmenu("disable"), $("#endTimeSelector").val(0).selectmenu("refresh").selectmenu("disable"), $("#numberOfImagesSelectorChange").selectmenu("enable")
}

function loadImageryTimes(e) {
    url_parameters = validateUrlParameters(), checkXYFarOffscreen(), all_tiles = [], initializeTimeArrays(e), getTimestampedMaps(all_times[0]), setupProductInfoArray(), $.each(url_parameters.p, function (e, t) {
        var r = $("#product" + leadingZeros(e, 2) + "Container button.productRemove");
        r.length && removeProduct(r.prop("value"), !0)
    }), $.each(url_parameters.p, function (e, t) {
        initializeProduct(t)
    ...
    }), getTimestampedMaps(all_times[0]), updateActiveProducts(), appendTiles(current_zoom_level, url_parameters.x, url_parameters.y);
    var t = tiles_in_view.length,
        r = all_tiles.length,
        a = r * t * url_parameters.im;
    a > 216 && !$("#autoRefresh").prop("checked") && createTemporaryMessage("Large Data Request", "Your current request will load approximately " + a + " tiles across " + r + " product(s).<br><br>If SLIDER is slow or unresponsive, consider lowering the number of images or lengthening the time step", !1, 1e4, 1e3), zoomToPoint(url_parameters.x, url_parameters.y, url_parameters.z, 0, 0, !1), resizeColorBar(), resetLoopSlider(), setArchiveModeState(), updateScaleBars()
}

function updateArchiveDropdownTimes(e, t, r, a = -1) {
    var o = $(e);
    o.empty(), o.append('<option disabled="disabled">' + r + " Time</option>"), o.append('<option selected="true" value="0">' + r + " Time Not Set</option>"), $.each(t, function (e, t) {
        o.append("<option value='" + t + "'>" + convertTimestampToDisplayTime(t.toString().slice(8)) + "</option>")
    }), o.selectmenu("enable"), -1 === a ? (o.val(0).selectmenu("refresh"), o.selectmenu("open"), $(e + "-button").focus()) : o.val(a.toString()).selectmenu("refresh")
}

function updateArchiveDropdownHours(e, t, r, a = -1) {
    $.ajax({
        type: "GET",
        ...
        success: function (t) {
            var o, l = $(e);
            if (l.empty(), l.append('<option disabled="disabled">' + r + " Hour</option>"), l.append('<option selected="true" value="0">' + r + " Hour Not Set</option>"), o = convertNestedTimestampsIfObject(t.timestamps_int), $.each(Object.keys(o).sort().reverse(), function (e, t) {
                    l.append('<option value="' + JSON.stringify(o[t]) + '">' + t + "</option>")
                }), l.selectmenu("enable"), -1 === a) l.val(0).selectmenu("refresh"), l.selectmenu("open"), $(e + "-button").focus();
            else {
                var s = a.toString().slice(8, 10);
                l.val(JSON.stringify(o[s])).selectmenu("refresh"), updateArchiveDropdownTimes(e.replace("Hour", "Time"), o[s], r, a)
            }
        }
    })
}
...
function findProperty(e, t, r, a) {
    var o;
    try {
        if (null == (o = json.satellites[t].products[a][e])) throw "No value at product level."
    } catch (a) {
        try {
            if (null == (o = json.satellites[t].sectors[r].defaults[e])) throw "No value at sector level."
        } catch (r) {
            try {
                if (null == (o = json.satellites[t].defaults[e])) throw "No value at satellite level."
            } catch (t) {
                try {
                    if (null == (o = json.defaults[e])) throw "No value at root level."
                } catch (e) {
                    console.log(a + "\n" + r + "\n" + t + "\n" + e)
                }
            }
...
function setupProductInfoArray() {
    $.each(productsObject, function (e, t) {
        var r, a;
        a = findProperty("starting_opacity", url_parameters.sat, url_parameters.sec, e), r = max_zoom_level - productsObject[e].zoom_level_adjust, product_setup_info[e] = [r, url_parameters.sat + "---" + url_parameters.sec + "/" + e + "/", ".png", all_times, !0, a, productsObject[e].product_title, productsObject[e].color_table_name, productsObject[e].product_description]
    })
}

function initializeProduct(e) {
    p = all_tiles.length, addProductToTileArray(p, product_setup_info[e][0], product_setup_info[e][1], product_setup_info[e][2], product_setup_info[e][3], product_setup_info[e][4], product_setup_info[e][5], product_setup_info[e][6], product_setup_info[e][7], product_setup_info[e][8]), addProductToDisplay(p, product_setup_info[e][5])
}
...
function startLoop() {
    stopLoop(), $("#playPause").button("option", "label", "Stop (space)"), 1 != needToPreloadTimesLater ? (loopJsSpeed = Math.abs($("#animationSpeed").slider("value")), loopJsTimer = setInterval(function () {
        setLoopingIndexToNextEnabledImage(), $("#loopSlider").slider("value", loopingIndex), updateActiveImageAndMessage(), setNextImage()
...
function moveImagery(e, t) {
    if (1 != zoom_animation_running) {
        ...
        var r = parseFloat($(window).width() / 6),
            a = $zoom_holder.offset().left,
            o = $zoom_holder.offset().top;
        if ("top" == e) {
            var l = {
                top: t + "=" + r,
                left: "+=0"
            };
            o = "+" == t ? $zoom_holder.offset().top + r : $zoom_holder.offset().top - r
        } else {
            l = {
                top: "+=0",
                left: t + "=" + r
            };
            a = "+" == t ? $zoom_holder.offset().left + r : $zoom_holder.offset().left - r
        }
        $zoom_holder.animate(l, {
            complete: function () {
                s = getCurrentImageryXY(), url_parameters.x = s.x, url_parameters.y = s.y, updateURL(), zoom_animation_running = 0
            }
        }), $("#comparisonSlider").animate({
            left: l.left
        });
        var s = convertZoomHolderXYToImageryXY(a, o);
        appendTiles(current_zoom_level, s.x, s.y)
    }
}
...
function animateZoom(e, t, r, a, o) {
    var l = !1,
        s = $("#mouseDrawOn").prop("checked"),
        i = $("#queryLatLon").prop("checked");
    $("div#canvas_wrapper").length && ($("div#canvas_wrapper").remove(), s && $("#mouseDrawOn").click(), i && $("#queryLatLon").click(), l = !0), removeFollowGraphics(), 0 != followFeatureClickMode && (followFeatureClickMode = 1, setFollowGraphicsCurrentInstruction(0, 1)), $zoom_holder.animate(e, {
        step: function (e, t) {
            !o || "width" !== t.prop && "height" !== t.prop ? r && "left" === t.prop ? t.start = r : a && "top" === t.prop && (t.start = a) : t.start = o
        },
        complete: function () {
            if (1 == rotate_on_load ? ($("#rotationAngle").slider("value", validateUIAngle(url_parameters.angle)), rotate_on_load = 0) : (xy = getCurrentImageryXY(), url_parameters.x = xy.x, url_parameters.y = xy.y, url_parameters.z = t, updateURL()), zoom_animation_running = 0, auto_refresh_on_load && ($("#autoRefresh").click(), auto_refresh_on_load = 0), 1 == slider_on_load && ($("#comparisonSliderCheckbox").click(), slider_on_load = 0), 1 == opacities_on_load) {
                1 == url_parameters.hide_controls && $("#menuHideShow").click(), $.each(url_parameters.opacity, function (e, t) {
                    ...
                    $("#" + e + "Container .mapHideShow").click()
                });
                var e = json.satellites[url_parameters.sat].products[url_parameters.p[0]];
                if (e.initial_message_content) $("#messageContainer .message-container-heading").after("<hr class='message-container-separator message-temporary'><h3 class='message-title message-temporary'>" + e.initial_message_title + "</h3><p class='message-content message-temporary'>" + e.initial_message_content + "</p>"), $("#messageContainer").show(), setTimeout(function () {
                    closeMessageContainer(3e3)
                }, 1e4);
                opacities_on_load = 0
            }
            if (json.satellites[url_parameters.sat].sectors[url_parameters.sec].lat_lon_query) {
                var r = $("#queryLatLon");
                r.prop("disabled", !1).button("refresh"), 1 == query_on_load && (r.click(), query_on_load = 0)
            }
            1 == mouse_draw_on_load && ($("#mouseDrawOn").click(), mouse_draw_on_load = 0), l && (s && $("#mouseDrawOn").click(), i && $("#queryLatLon").click()), 0 == url_parameters.follow_hide && followXVector && followYVector && drawFollowVector()
        }
    });
    var n = $("#comparisonSlider");
    n.length && ($(".product_holder").animate({
        width: e.width,
        height: e.height
        ...
        width: e.width,
        left: e.left
    }), n.slider("option", "step", Math.pow(2, max_zoom_level - t)), $("#comparisonSliderWrapper").animate({
        width: n.slider("value") / Math.pow(2, max_zoom_level - t)
    }))
}

function closeMessageContainer(e = 1e3) {
    $("#messageContainer").fadeOut(e, function () {
        temporaryMessageTimeoutStartedAt = null, temporaryMessageTimeoutLength = 0, $(".message-temporary").remove()
    })
}

function zoomToPoint(e, t, r, a, o, l) {
    if (a = defaultFor(a, 0), o = defaultFor(o, 0), l = defaultFor(l, 1), r > max_zoom_level_user) alert("Can't zoom in any further.");
    else if (r < 0) alert("Can't zoom out any further.");
    else if (1 != zoom_animation_running) {
        zoom_animation_running = 1;
        var s = {};
        current_zoom_level = r;
        var i = e / Math.pow(2, max_zoom_level - r) * -1,
            n = t / Math.pow(2, max_zoom_level - r) * -1,
            c = {
                left_move: 0,
                top_move: 0
            };
        rotate_on_load || (c = calculateRotationMotion(url_parameters.angle, r)), s.width = tile_size * Math.pow(2, r), s.height = tile_size * Math.pow(2, r);
        ...
        if (rotate_on_load || $zoom_holder.css({
            ...
            }), s.left = i + a + c.left_move, s.top = n + o + c.top_move, animateZoom(s, r, u, p, d), l) {
            var y = convertZoomHolderXYToImageryXY($(window).width() / 2 + i, $(window).height() / 2 + n);
            appendTiles(current_zoom_level, y.x, y.y)
        }
        setFollowVectors(), updateScaleBars()
    }
}
...
function removeTiles() {
    if (0 != tiles_in_view_before.length) {
        ...
        for (var t = 0; t < all_tiles.length; t++)
            for (var r = leadingZeros(t, 2), a = 0; a < e.length; a++) {
                var o = e[a][0],
                    l = e[a][1],
                    s = e[a][2];
                if (!(current_zoom_level >= all_tiles[t][0].length - 1 && o >= all_tiles[t][0].length - 1)) {
                    if (o > all_tiles[t][0].length - 1) {
                        var i = all_tiles[t][0].length - 1;
                        l = translateTileNumber(l, o, i), s = translateTileNumber(s, o, i)
                    } else i = o;
                    all_tiles[t][0][i][l][s][0] = !1, all_tiles[t][0][i][l][s][1] = !1, all_tiles[t][0][i][l][s][2] = !1, $(".product_holder .p" + r + tile_filenames[i][l][s][1]).remove()
                }
            }
        $.each(map_lat_lon_tiles, function (t, r) {
            for (var a = 0; a < e.length; a++) {
                var l = e[a][0],
                    s = e[a][1],
                    i = e[a][2];
                if (!(current_zoom_level >= map_lat_lon_tiles[t][0].length - 1 && o >= map_lat_lon_tiles[t][0].length - 1)) {
                    if (o > map_lat_lon_tiles[t][0].length - 1) {
                        l = map_lat_lon_tiles[t][0].length - 1;
                        s = translateTileNumber(s, o, l), i = translateTileNumber(i, o, l)
                    } else l = o;
                    map_lat_lon_tiles[t][0][l][s][i][0] = !1, map_lat_lon_tiles[t][0][l][s][i][1] = !1, map_lat_lon_tiles[t][0][l][s][i][2] = !1, $(".map_lat_lon_holder .p-" + t + tile_filenames[l][s][i][1]).remove()
                }
            }
...
function hideMapLatLon(e) {
    $("#holder-" + e).hide(), map_lat_lon_tiles[e] && (map_lat_lon_tiles[e][4] = !1), "lat" == e && (url_parameters[e] = 0), updateURL()
}
...
function getTimesToLoad() {
    var e = [],
        t = [];
    return loopJsTimer || loopJsPauseTimer || loopWasRunning || needToPreloadTimesLater ? ($.each(all_times, function (r, a) {
        a < current_time ? e.push(a) : t.push(a)
    }), t = t.concat(e)) : (t.push(current_time), needToPreloadTimesLater = !0), t
}

function getTilesToLoadRotated(e, t, r) {
    for (var a = Math.sqrt(Math.pow($(window).width() / 2, 2) + Math.pow($(window).height() / 2, 2)) * Math.pow(2, max_zoom_level - e), o = Math.pow(2, e) - 1, l = [], s = 0, i = 0; i <= o; i++)
        for (var n = 0; n <= o; n++) {
            var c = convertScreenPixelsToBigPixels(n * sector_array.tile_size),
                u = convertScreenPixelsToBigPixels(i * sector_array.tile_size),
                p = convertScreenPixelsToBigPixels(sector_array.tile_size);
            Math.min(calculateDistanceBetweenXYs(t, r, c, u), calculateDistanceBetweenXYs(t, r, c + p, u), calculateDistanceBetweenXYs(t, r, c, u + p), calculateDistanceBetweenXYs(t, r, c + p, u + p), calculateDistanceBetweenXYs(t, r, c + p / 2, u + p / 2)) <= a * (1 + convertBigPixelsToScreenPixels(.26)) && (l[s] = [e, i, n], s++)
        }
    return l
}

function appendTiles(e, t, r, a) {
    if (current_time) {
        a = defaultFor(a, ""), 0 != tiles_in_view.length && (0 != tiles_in_view_before.length ? tiles_in_view_before.push.apply(tiles_in_view_before, tiles_in_view) : tiles_in_view_before = tiles_in_view), tiles_in_view = getTilesToLoadRotated(e, t, r);
        for (var o = 0; o < all_tiles.length; o++) {
            var l = server_root + current_time.toString().substr(0, 8) + "/" + all_tiles[o][1] + current_time + "/";
            appendTilesForProduct(o, e, l)
        }
        $.each(map_lat_lon_tiles, function (t, r) {
            if (map_lat_lon_tiles[t] && 1 == map_lat_lon_tiles[t][4]) {
                var o = map_lat_lon_tiles[t][1] + (a || map_time) + "/";
                appendTilesForMapLatLon(t, e, o)
            }
...
function appendTilesForProduct(e, t, r) {
    var a = e,
        o = leadingZeros(a, 2),
        l = "product_holder_" + o;
    if (t > all_tiles[a][0].length - 1) var s = all_tiles[a][0].length - 1;
    else s = t;
    var i = "zoom_level_" + leadingZeros(s, 2);
    $("#" + l).length || $product_wrapper.append("<div id='" + l + "' class='product_holder'></div>");
    var n = $("#product" + leadingZeros(a, 2) + "Opacity").slider("value");
    $("#product_holder_" + leadingZeros(a, 2)).css("opacity", n), $("#" + l + "> ." + i).length || $("#" + l).append("<div class='" + i + " zoom_level'></div>"), 0 == $("#" + l + "> ." + i).is(":visible") && $("#" + l + "> ." + i).show();
    for (var c = 0; c < tiles_in_view.length; c++) {
        var u = tiles_in_view[c][1],
            p = tiles_in_view[c][2];
        t > s && (u = translateTileNumber(u, t, s), p = translateTileNumber(p, t, s)), 0 == all_tiles[a][0][s][u][p][0] ? ($("#" + l + "> ." + i).append('<img class="p' + o + tile_filenames[s][u][p][2] + '" src="' + r + tile_filenames[s][u][p][0] + all_tiles[a][2] + '" alt="Image tile showing part of the imagery for zoom level ' + s + ", row " + u + ", column " + p + '" />'), all_tiles[a][0][s][u][p][0] = !0, all_tiles[a][0][s][u][p][1] = !0) : (all_tiles[a][0][s][u][p][1] = !0, $(".p" + o + tile_filenames[s][u][p][1]).show())
    }
}

function appendTilesForMapLatLon(e, t, r) {
    var a = "holder-" + e;
    if (t > map_lat_lon_tiles[e][0].length - 1) var o = map_lat_lon_tiles[e][0].length - 1;
    else o = t;
    var l = "zoom_level_" + leadingZeros(o, 2);
    $("#" + a).length || $map_wrapper.append("<div id='" + a + "' class='map_lat_lon_holder'></div>"), $("#" + a + "> ." + l).length || $("#" + a).append("<div class='" + l + " zoom_level'></div>"), 0 == $("#" + a + "> ." + l).is(":visible") && $("#" + a + "> ." + l).show();
    for (var s = 0; s < tiles_in_view.length; s++) {
        var i = tiles_in_view[s][1],
            n = tiles_in_view[s][2];
        t > o && (i = translateTileNumber(i, t, o), n = translateTileNumber(n, t, o)), 0 == map_lat_lon_tiles[e][0][o][i][n][0] ? ($("#" + a + "> ." + l).append('<img class="p-' + e + tile_filenames[o][i][n][2] + '" src="' + r + tile_filenames[o][i][n][0] + map_lat_lon_tiles[e][2] + '" alt="Image tile showing part of the map or lat/lon grid for the imagery for zoom level ' + o + ", row " + i + ", column " + n + '" />'), map_lat_lon_tiles[e][0][o][i][n][0] = !0, map_lat_lon_tiles[e][0][o][i][n][1] = !0) : (map_lat_lon_tiles[e][0][o][i][n][1] = !0, $(".p-" + e + tile_filenames[o][i][n][1]).show())
    }
}
...
function getCurrentImageryXYAtPoint(e, t, r = !0) {
    ...
    var a = sector_array.tile_size / 2 * Math.pow(2, current_zoom_level),
        o = getRotationAdjustment(a),
        l = e - $zoom_holder.offset().left - o,
        s = t - $zoom_holder.offset().top - o,
        i = url_parameters.angle,
        n = i < 0 ? i + 360 : i,
        c = l - a,
        u = -1 * (s - a),
        ...
        _ = s + -1 * p * (1 - Math.cos(-1 * d * Math.PI / 180) - (1 - Math.cos(-1 * (d - n) * Math.PI / 180)));
    return xy = {
...
function checkXYFarOffscreen() {
    var e = json.satellites[url_parameters.sat].sectors[url_parameters.sec].tile_size * Math.pow(2, json.satellites[url_parameters.sat].sectors[url_parameters.sec].max_zoom_level) / 2,
        t = convertScreenPixelsToBigPixels($(window).width()),
        r = convertScreenPixelsToBigPixels($(window).height()),
        a = 2 * e + t / 2,
        o = t / 2 * -1,
        l = 2 * e + r / 2,
        s = r / 2 * -1;
    (url_parameters.x > a || url_parameters.x < o || url_parameters.y > l || url_parameters.y < s) && (url_parameters.x = e, url_parameters.y = e, url_parameters.z = 0, updateURL())
}

function updateURL(e, t, r) {
    if (e = defaultFor(e, 0), t = defaultFor(t, 0), r = defaultFor(r, 0), 1 == e && 0 == t && setDefaultsForSatellite(), 1 == e || 1 == t) {
        var a = json.satellites[url_parameters.sat].products,
            o = json.satellites[url_parameters.sat].sectors[url_parameters.sec].missing_products;
        (!url_parameters.p || !a[url_parameters.p[0]] || o && o[url_parameters.p[0]]) && (url_parameters.p = {
            0: json.satellites[url_parameters.sat].sectors[url_parameters.sec].default_product
        });
    ...
    1 != e && 1 != r || (url_parameters.opacity = {
        0: 1
    }, url_parameters.hidden = {}), 1 != e && 1 != t && 1 != r || (url_parameters.slider = -1), sector_array = json.satellites[url_parameters.sat].sectors[url_parameters.sec], productsObject = getProductsObject(), checkForProductNumbers(), url_parameters.p[0] in productsObject || (url_parameters.p = {
        0: json.satellites[url_parameters.sat].sectors[url_parameters.sec].default_product
...
function addProductToDisplay(e, t) {
    var r = e;
    $("#dummyHolder").after("<li id='product" + leadingZeros(r, 2) + "Container' class='productContainer'><label for='product" + leadingZeros(r, 2) + "Container'>" + all_tiles[r][7] + "</label><input class='productNumber' type='hidden' value='" + r + "' /><button class='productRemove' title='Completely remove this product from view.' value='" + r + "'></button><label class='productHideShowLabel' for='productHideShow" + r + "'>Hide</label><input type='checkbox' class='productHideShow' name='productHideShow" + r + "' id='productHideShow" + r + "' title='Hide/Show this product temporarily.' value='" + r + "'><div class='opacityWrapper' title='Control the opacity for this product'><div id='product" + leadingZeros(r, 2) + "Opacity' class='opacitySlider'></div></div><button class='productInfo' title='Click for more info about this band/product' value='" + r + "'></button></li>"), setupProductBoxUI(r, t), showProduct(r)
}

function changeOpacity(e, t, r) {
    var a = e.parents("li").children(".productNumber").prop("value");
    all_tiles[a][5] = r.value, url_parameters.opacity[a] = r.value, $("#product_holder_" + leadingZeros(a, 2)).css("opacity", r.value), updateURL()
}

function setupProductBoxUI(e, t) {
    var r = e;
    $("#product" + leadingZeros(r, 2) + "Container div.opacityWrapper div.opacitySlider").slider({
        value: url_parameters.opacity[r] || t,
        min: 0,
        max: 1,
        step: .01,
        change: function (e, t) {
    ...
    }), $("#product" + leadingZeros(r, 2) + "Container button.productRemove").button({
        label: "x"
    }).on("click", function () {
        removeProduct(parseInt($(this).prop("value")))
    }), $("#product" + leadingZeros(r, 2) + "Container .productHideShow").checkboxradio().on("click", function () {
        var e = $(this).prop("value");
        this.checked ? (url_parameters.hidden[e] = 1, hideProduct(e)) : (delete url_parameters.hidden[e], showProduct(e)), updateURL()
    ...
    }), $("#product" + leadingZeros(r, 2) + "Container button.productInfo").button({
        label: "Info"
    }).on("click", function () {
...
function removeProduct(e, t = !1) {
    if (null == e) return !1;
    if (!t && 1 == all_tiles.length) return alert("The last product can't be deleted. Please use the \"(P)roduct\" menu to switch to another product you'd like to view."), !1;
    var r = leadingZeros(e, 2),
        a = 0;
    ...
    if ($("#productSelectorOverlay option[ value='" + url_parameters.p[e] + "']").prop("disabled", !1), $("#productSelectorOverlay").selectmenu("refresh"), $("#productSelectorOverlay-menu .ui-menu-item-wrapper:contains('----------')").addClass("productHeading"), $(".productHeading").parent().css({
            opacity: 1
        }), $("#product_holder_" + r).remove(), $("#product" + leadingZeros(e, 2) + "Container").remove(), e == all_tiles.length - 1) $.each(["p", "opacity", "hidden"], function (t, r) {
        delete url_parameters[r][e]
    });
    else
        for (i = e; i < all_tiles.length - 1; i++) $("#product" + leadingZeros(i + 1, 2) + "Container label").attr("for", "productHideShow" + i), $("#product" + leadingZeros(i + 1, 2) + "Container input.productNumber").attr("value", i), $("#product" + leadingZeros(i + 1, 2) + "Container button.productRemove").val(i), $("#product" + leadingZeros(i + 1, 2) + "Container .productHideShow").val(i), $("#product" + leadingZeros(i + 1, 2) + "Container .productHideShow").attr("id", "productHideShow" + i), $("#product" + leadingZeros(i + 1, 2) + "Container .productHideShow").attr("name", "productHideShow" + i), $("#product" + leadingZeros(i + 1, 2) + "Opacity").attr("id", "product" + leadingZeros(i, 2) + "Opacity"), $("#product" + leadingZeros(i + 1, 2) + "Container button.productInfo").val(i), $("#product" + leadingZeros(i + 1, 2) + "Container").attr("id", "product" + leadingZeros(i, 2) + "Container"), $("#product_holder_" + leadingZeros(i + 1, 2)).attr("id", "product_holder_" + leadingZeros(i, 2)), $("img.p" + leadingZeros(i + 1, 2)).removeClass("p" + leadingZeros(i + 1, 2)).addClass("p" + leadingZeros(i, 2)), $.each(["p", "opacity", "hidden"], function (e, t) {
            null != url_parameters[t][i + 1] && (Object.defineProperty(url_parameters[t], i, Object.getOwnPropertyDescriptor(url_parameters[t], i + 1)), delete url_parameters[t][i + 1])
        });
    updateURL(), all_tiles.splice(e, 1), all_tiles.length > 1 && 1 == a && $("#comparisonSliderCheckbox").click(), all_tiles.length < 3 && $("#productSelectorOverlay").selectmenu("enable"), $.isEmptyObject(all_tiles) || updateActiveProducts()
}
...
function loopSliderChange(e, t) {
    var r, a, o, l, s, i;
    ($("#imageryTime").text(all_tiles[0][6][t.value]), $("p#imageryTimeBottom ").text(all_tiles[0][6][t.value]), current_time = all_times[t.value], loopingIndex = t.value, 1 == url_parameters.follow_feature) && (r = (a = followXVector * (loopingIndex - loopingIndexPrevious)) < 0 ? "+" : "-", l = (s = followYVector * (loopingIndex - loopingIndexPrevious)) < 0 ? "+" : "-", o = Math.abs(a), i = Math.abs(s), $zoom_holder.css({
        left: r + "=" + o,
        top: l + "=" + i
    }));
    updateTiles(all_tiles[0][3][t.value]), setImageryFlagMessage(), loopingIndexPrevious = loopingIndex
}

function calculateRotationMotion(e, t = url_parameters.z) {
    var r = (e = parseInt(e)) - url_parameters.angle || e;
    angle_360 = e < 0 ? e + 360 : e;
    var a = sector_array.tile_size / 2 * Math.pow(2, max_zoom_level),
        o = url_parameters.x - a,
        l = -1 * (url_parameters.y - a),
        s = Math.sqrt(Math.pow(o, 2) + Math.pow(l, 2)) / Math.pow(2, max_zoom_level - t),
        i = 180 * Math.atan(o / l) / Math.PI + (l <= 0 ? 180 : 0) || 0,
        n = angle_360 + i,
        c = s * (Math.sin(n * Math.PI / 180) - Math.sin((n - r) * Math.PI / 180)),
        u = s * (1 - Math.cos(n * Math.PI / 180) - (1 - Math.cos((n - r) * Math.PI / 180)));
    return {
        angle_360: angle_360,
        left_move: -1 * c,
        top_move: -1 * u
...
function updateActiveImageAndMessage() {
    updateActiveImage(), setImageryFlagMessage()
}
...
function setImageryFlagMessage() {
    if (!$.isEmptyObject(all_times_flags)) {
        var e = $("#imageryFlagMessage"),
            t = "syn" == all_times_flags[all_times[loopingIndex]],
            r = t ? "Synthetic Non-Operational Imagery" : "Redisplayed Operational Imagery",
            a = r + "&nbsp".repeat(50) + r,
            o = t ? "imagery-flag-message-red" : "";
        e.removeClass("imagery-flag-message-red"), e.addClass(o), e.html(a)
    }
}

function nextImage() {
    var e = $("#loopSlider");
    $(".ui-slider-handle").is(":focus") || (e.slider("value") != e.slider("option", "max") ? e.slider("value", e.slider("value") + 1) : e.slider("value", e.slider("option", "min")), updateActiveImageAndMessage(), updateDynamicUrlValues(), updateURL()), 1 == needToPreloadTimesLater && preloadAfterPaused(!1)
}

function previousImage() {
    var e = $("#loopSlider");
    $(".ui-slider-handle").is(":focus") || (e.slider("value") != e.slider("option", "min") ? e.slider("value", e.slider("value") - 1) : e.slider("value", e.slider("option", "max")), updateActiveImageAndMessage(), updateDynamicUrlValues(), updateURL()), 1 == needToPreloadTimesLater && preloadAfterPaused(!1)
}
    ...
    if ("" != productsObject[url_parameters.p[0]].color_table_name) {
        ...
        for (i = 0; i < t.length; i++)
            if ($(window).width() - 250 < t[i]) {
                e = ("0" + t[i]).slice(-4);
                break
            } $("#colorBar1").attr("src", server_root_2 + "color_bar/" + url_parameters.sat + "/color_bar_" + e + "_" + productsObject[url_parameters.p[0]].color_table_name + ".png")
    }
}
...
$("#messageContainerClose").on("click", function () {
    $("#messageContainer").find(".message-lat-lon-query").length && $("#queryLatLon").prop("checked") && $("#queryLatLon").click(), closeMessageContainer()
...
}), $("button#canvasClear, button#canvasClearPopout").button().click(function (e) {
...
var recoupLeft, recoupTop, xy_at_mouse_down = {};

function resetOnQueryOff() {
    removeAnyQueryDrawings(), first_page_xy_query = {}, second_page_xy_query = {}, first_lat_lon_query = {}, distance = void 0, measuring_length = !1
}
...
function createCanvas() {
    ...
    var e = 3 * $(window).width(),
        t = 3 * $(window).height();
    ctx.canvas.width = e, ctx.canvas.height = t;
    var r = getCurrentImageryXY(),
        a = convertBigPixelsToScreenPixels(r.x) - e / 2,
        o = convertBigPixelsToScreenPixels(r.y) - t / 2;
...
function setRotationAngleWithKeyboard(e) {
    var t = $("#rotationAngle"),
        ...
        a = validateUIAngle(t.slider("value") + r);
    t.slider("value", a)
}

function setCenterForMouseRegion(e, t, r) {
    var a = convertPageXYToImageXY(e, t),
        o = getCurrentImageryXY(),
        l = a.x + (o.x - a.x) / Math.pow(2, r),
        s = a.y + (o.y - a.y) / Math.pow(2, r);
    url_parameters.x = l, url_parameters.y = s, updateURL()
}
...
function updateActiveProducts() {
    $("#productSelectorChange-menu .ui-menu-item-wrapper").removeClass("activeProduct"), $.each(url_parameters.p, function (e, t) {
        if ($("#product" + leadingZeros(e, 2) + "Container button.productRemove").length) {
            var r = decodeEntities(all_tiles[e][7]);
            $("#productSelectorChange-menu .ui-menu-item-wrapper:contains('" + r + "')").addClass("activeProduct")
        }
    })
}
$("#mouseDrawOn").checkboxradio().click(function (e) {
    this.checked ? ($zoom_holder.unbind("mousemove"), $zoom_holder.draggable("disable"), 0 == $("#canvas_wrapper").length && createCanvas(), $drawingCanvas.mousemove(function (e) {
    ...
    }), url_parameters.mouse_draw = 1, updateURL(), $("#mouseDrawPopout").fadeIn(200)) : ($drawingCanvas.unbind("mousemove"), $drawingCanvas.unbind("mousedown"), $drawingCanvas.unbind("mouseup"), $drawingCanvas.unbind("mousemout"), $("#queryLatLon").prop("checked") || $zoom_holder.draggable("enable"), xy_at_mouse_down = {}, url_parameters.mouse_draw = 0, updateURL(), $("#mouseDrawPopout").fadeOut(200)), blurObject(this)
}), $("#mouseDrawPopoutClose").click(function () {
    $("#mouseDrawOn").click()
}), $("#mouseDrawAddText").click(function () {
    $("#queryLatLon").prop("checked") && $("#queryLatLon").click()
}), $("#mouseDrawPopout .draw-action").click(function () {
    $("#mouseDrawPopout .draw-action").removeClass("draw-active"), $(this).addClass("draw-active"), "mouseDrawErase" == $(this)[0].id ? ctx.globalCompositeOperation = "destination-out" : ctx.globalCompositeOperation = "source-over"
}), $("#queryLatLon").checkboxradio().click(function () {
    if (this.checked) {
        if (url_parameters.q = 1, updateURL(), $zoom_holder.unbind("mousemove"), $zoom_holder.draggable("disable"), 0 == $("#canvas_wrapper").length && createCanvas(), show_query_help) {
            var e = json.satellites[url_parameters.sat].sectors[url_parameters.sec].lat_lon_query.decimal_places - 1;
            createTemporaryMessage("Query Lat/Lon On", "Lat/Lon will now be shown in a box like this after a single left-click.<br><br>(Values typically accurate to within 0." + "0".repeat(e) + "1° and worsen near the limbs)<br><br>Dragging has been disabled.", !1, 5e3, 1e3), show_query_help = 0
        }
    } else $("#mouseDrawOn").prop("checked") || $zoom_holder.draggable("enable"), resetOnQueryOff(), delete url_parameters.q, updateURL();
    updateScaleBars()
}), $("#drawColor").selectmenu({
    change: function (e, t) {
        url_parameters.draw_color = $(this).val().substring(1), updateURL(), draw_color = $(this).val(), $(" #drawColor-button ").css("background-color", draw_color)
    }
}), $("#drawWidth").selectmenu({
    change: function (e, t) {
        url_parameters.draw_width = $(this).val(), updateURL(), draw_width = $(this).val()
    }
    ...
    var t, r;
    e.originalEvent.wheelDelta ? 0 == (r = Math.floor(e.originalEvent.wheelDelta / 120)) && (r = e.originalEvent.wheelDelta > 0 ? 1 : -1) : e.originalEvent.detail && 0 == (r = Math.floor(e.originalEvent.detail / -7)) && (r = e.originalEvent.detail > 0 ? -1 : 1), (t = current_zoom_level + r) > max_zoom_level_user ? t = max_zoom_level_user : t < 0 && (t = 0), r = t - current_zoom_level, setCenterForMouseRegion(e.pageX, e.pageY, r), zoomToPoint(url_parameters.x, url_parameters.y, url_parameters.z + r)
}), $zoom_holder.draggable({
    scroll: !1,
    start: function (e, t) {
        var r = parseInt($(this).css("left")),
            a = parseInt($(this).css("top"));
        recoupLeft = r - t.position.left, recoupTop = a - t.position.top
    },
    stop: function () {
        var e = getCurrentImageryXY();
        url_parameters.x = e.x, url_parameters.y = e.y, url_parameters.z = current_zoom_level, updateURL(), appendTiles(current_zoom_level, e.x, e.y), moveZoomHolderDiamond(), updateScaleBars()
    },
    drag: function (e, t) {
    ...
    change: function (e, t) {
        var r = $(this).val();
        if (testUrl = (server_root.includes("http") ? "" : window.location.origin) + server_root + all_tiles[0][3][0].toString().slice(0, 8) + "/" + url_parameters.sat + "---" + url_parameters.sec + "/" + r + "/" + all_tiles[0][3][0] + "/00/000_000.png", urlExists(testUrl)) {
            var a = {};
            a[Object.keys(url_parameters.p).length] = r, $.extend(url_parameters.p, a), Object.keys(url_parameters.p).length >= 3 && $("#productSelectorOverlay").selectmenu("disable"), $("#productSelectorOverlay option[ value='" + r + "']").prop("disabled", !0), $("#productSelectorOverlay").selectmenu("refresh"), $("#productSelectorOverlay-menu .ui-menu-item-wrapper:contains('----------')").addClass("productHeading"), $(".productHeading").parent().css({
                opacity: 1
            }), initializeProduct(r);
            var o = {};
            o[Object.keys(url_parameters.opacity).length] = all_tiles[all_tiles.length - 1][5], $.extend(url_parameters.opacity, o), updateURL(), updateActiveProducts();
            var l = convertZoomHolderXYToImageryXY($zoom_holder.offset().left, $zoom_holder.offset().top);
            appendTiles(current_zoom_level, l.x, l.y), $("#product" + leadingZeros(all_tiles.length - 1, 2) + "Container div.opacityWrapper div.opacitySlider").slider("value", all_tiles[all_tiles.length - 1][5]), $("#comparisonSliderCheckbox").button("enable"), -1 != url_parameters.slider && ($("#comparisonSliderCheckbox").click(), $("#comparisonSliderCheckbox").click())
        } else alert("This product is not available for this timeframe.");
        blurObject(this)
    }
});
var auto_refresh_js_interval, mapSelectorFn = function (e, t) {
    var r = $(this).val();
...
function changeMapOpacity(e, t, r) {
    var a = e.attr("map");
    url_parameters.mops[a] = r.value, $("#holder-" + a).css("opacity", r.value), updateURL()
}
...
function arrowClickShouldChangeSatellite(e) {
    ...
    if ("up" == e) {
        var r = (url_parameters.x <= t ? 1 : -1) * convertScreenPixelsToBigPixels($(window).width() / 2),
            a = Math.max(Math.min(url_parameters.x + r, t), 0);
        adjustmentCrossesCenterLine(url_parameters.x, a, t) && (a = t);
        var o = (t ** 2 - (t - a) ** 2) ** .5;
        if (url_parameters.y - convertScreenPixelsToBigPixels($(window).height() / 2) < t - o) return !0
    } else if ("down" == e) {
        r = (url_parameters.x <= t ? 1 : -1) * convertScreenPixelsToBigPixels($(window).width() / 2), a = Math.max(Math.min(url_parameters.x + r, t), 0);
        adjustmentCrossesCenterLine(url_parameters.x, a, t) && (a = t);
        o = (t ** 2 - (t - a) ** 2) ** .5;
        if (url_parameters.y + convertScreenPixelsToBigPixels($(window).height() / 2) > t + o) return !0
    } else if ("left" == e) {
        var l = (url_parameters.y <= t ? 1 : -1) * convertScreenPixelsToBigPixels($(window).height() / 2),
            s = Math.max(Math.min(url_parameters.y + l, t), 0);
        adjustmentCrossesCenterLine(url_parameters.y, s, t) && (s = t);
        var i = (t ** 2 - (t - s) ** 2) ** .5;
        if (url_parameters.x - convertScreenPixelsToBigPixels($(window).width() / 2 - ($("#menuHideShow").prop("checked") ? 0 : 250)) < t - i) return !0
    } else if ("right" == e) {
        l = (url_parameters.y <= t ? 1 : -1) * convertScreenPixelsToBigPixels($(window).height() / 2), s = Math.max(Math.min(url_parameters.y + l, t), 0);
        adjustmentCrossesCenterLine(url_parameters.y, s, t) && (s = t);
        i = (t ** 2 - (t - s) ** 2) ** .5;
        if (url_parameters.x + convertScreenPixelsToBigPixels($(window).width() / 2) > t + i) return !0
    }
    return !1
}
...
$("#mapSelector").selectmenu({
    ...
    change: function (e, t) {
        ...
        if (url_parameters.ts = r, 1 == url_parameters.follow_feature && followXVector && followYVector) {
            var o, l = getOrderedFollowValues(url_parameters.follow_x),
                s = getOrderedFollowValues(url_parameters.follow_y),
                i = loopingIndexMax + 1,
                n = i,
                c = calculateFirstLastImagePosition(l.followValues[0], s.followValues[0], l.followValues[1], s.followValues[1], l.imageNumbers[0], l.imageNumbers[1], i);
            if (0 != url_parameters.st && 0 == url_parameters.et) o = calculateFirstLastImagePosition(c.x0, c.y0, c.x1 - (c.x1 - c.x0) * (1 - r / a), c.y1 - (c.y1 - c.y0) * (1 - r / a), 0, i - 1, i);
            else if (0 != url_parameters.st && 0 != url_parameters.et) {
                if (r > i * a) return alert("Time step is greater than then number of images. Please increase the time between the start and end time of your images to keep the feature-following loop enabled."), url_parameters.ts = a, $(this).val(a), $(this).selectmenu("refresh"), updateURL(), void blurObject(this);
                delete url_parameters.follow_x[l.imageNumbers[0]], delete url_parameters.follow_y[s.imageNumbers[0]], delete url_parameters.follow_x[l.imageNumbers[1]], delete url_parameters.follow_y[s.imageNumbers[1]], n = Math.round(i / (r / a)), o = calculateFirstLastImagePosition(c.x0, c.y0, c.x1, c.y1, 0, n - 1, n), l.imageNumbers[0] = 0, s.imageNumbers[0] = 0, l.imageNumbers[1] = n - 1, s.imageNumbers[1] = n - 1
            } else o = calculateFirstLastImagePosition(c.x0 + (c.x1 - c.x0) * (1 - r / a), c.y0 + (c.y1 - c.y0) * (1 - r / a), c.x1, c.y1, 0, i - 1, i);
            var u = calculateFollowCoordinates(o.x0, o.y0, o.x1, o.y1, n, 0);
            url_parameters.follow_x[l.imageNumbers[0]] = u[l.imageNumbers[0]][0], url_parameters.follow_y[s.imageNumbers[0]] = u[s.imageNumbers[0]][1], url_parameters.follow_x[l.imageNumbers[1]] = u[l.imageNumbers[1]][0], url_parameters.follow_y[s.imageNumbers[1]] = u[s.imageNumbers[1]][1]
        }
    ...
    change: function (e, t) {
        ...
        if (url_parameters.im = r, 1 == url_parameters.follow_feature && followXVector && followYVector) {
            var l, s, i = a - o,
                ...
                p = calculateFirstLastImagePosition(c.followValues[0], u.followValues[0], c.followValues[1], u.followValues[1], c.imageNumbers[0], c.imageNumbers[1], o),
                d = calculateFollowCoordinates(p.x0, p.y0, p.x1, p.y1, o, 0);
...
var auto_refresh_frequency = 6e4;

function autoRefreshCheck() {
    getLatestTimes(!0)
}
$("#autoRefresh").checkboxradio().click(function (e) {
    this.checked ? ($("#archive").prop("checked") && $("#archive").click(), $("#followFeature").prop("checked") && $("#followFeature").click(), auto_refresh_interval = setInterval(function () {
        autoRefreshCheck()
    }, auto_refresh_frequency), url_parameters.refresh = 1) : (clearInterval(auto_refresh_interval), delete url_parameters.refresh), updateURL(), blurObject(this)
    ...
    "0px" != $("#controlWrapper").css("left") ? ($("#controlWrapper").animate({
        ...
        left: "255px"
    }), $("#navigation-arrow-up").removeClass("menu-closed", 400), $("#navigation-arrow-down").removeClass("menu-closed", 400), $("#imageryFlagMessage").removeClass("menu-closed", 400), $("#mouseDrawOn").prop("checked") && $("#mouseDrawPopout").delay(200).fadeIn(), url_parameters.hide_controls = 0, updateURL()) : ($("#mouseDrawPopout").fadeOut(), $("#controlWrapper").animate({
        left: "-250px"
    }), $("label[ for=menuHideShow ]").animate({
        left: "0px"
    }), $(" #navigation-arrow-left").animate({
        left: "0px"
    }), $("#navigation-arrow-up").addClass("menu-closed", 400), $("#navigation-arrow-down").addClass("menu-closed", 400), $("#imageryFlagMessage").addClass("menu-closed", 400), url_parameters.hide_controls = 1, updateURL()), blurObject(this)
    ...
    var e = parseInt($("#colorBarWrapper").css("height")),
        t = e + 6 + "px";
    $("#navigation-arrow-down").css("bottom", t), $("#logosAndScaleBars").css("bottom", 6 + e)
...
function draw() {
    ctx.beginPath(), ctx.moveTo(prevX, prevY), ctx.lineTo(currX, currY), ctx.strokeStyle = draw_color, ctx.lineWidth = draw_width, ctx.stroke(), ctx.moveTo(currX, currY), ctx.fillStyle = draw_color, ctx.fillColor = draw_color, ctx.arc(currX, currY, draw_width / 2, 0, 2 * Math.PI, !1), ctx.fill(), ctx.closePath()
}

function findXYForDrawing(e, t) {
    "down" == e && (prevX = currX, prevY = currY, currX = t.offsetX, currY = t.offsetY, $("#mouseDrawArrow").hasClass("draw-active") && (arrowLogX = [currX], arrowLogY = [currY]), drawing_active = !0), "up" != e && "out" != e || ("up" == e && $("#mouseDrawArrow").hasClass("draw-active") && drawArrowhead(), drawing_active = !1), "move" == e && drawing_active && (prevX = currX, prevY = currY, currX = t.offsetX, currY = t.offsetY, $("#mouseDrawArrow").hasClass("draw-active") && (arrowLogX.push(currX), arrowLogY.push(currY), arrowLogX.length > arrowLogLength && (arrowLogX.shift(), arrowLogY.shift())), $("#mouseDrawAddText").hasClass("draw-active") || draw())
}

function drawArrowhead() {
    if (currX != arrowLogX[0] || currY != arrowLogY[0]) {
        var e = Math.atan2(currY - arrowLogY[0], currX - arrowLogX[0]) + Math.PI / 2,
            t = 4 * draw_width;
        ctx.beginPath(), ctx.moveTo(currX, currY), ctx.lineTo(currX + t * Math.cos(Math.PI / 4 + e), currY + t * Math.sin(Math.PI / 4 + e)), ctx.strokeStyle = draw_color, ctx.lineWidth = draw_width, ctx.stroke(), ctx.moveTo(currX, currY), ctx.lineTo(currX - t * Math.sin(Math.PI / 4 + e), currY + t * Math.cos(Math.PI / 4 + e)), ctx.strokeStyle = draw_color, ctx.lineWidth = draw_width, ctx.stroke(), ctx.closePath()
    }
}
...
var right_click_timeout, right_click_x, right_click_y, mouse_x, mouse_y, current_time, map_time, pause_loop_rock_rev = 0,
    ...
    max_zoom_level_user = max_zoom_level + 2,
...
for ($("#custom-menu").append('<li style="font-weight: bold;">-- Overzoom --</li>'), i = max_zoom_level + 1; i <= max_zoom_level_user; i++) {
    var split_max_res = json.satellites[url_parameters.sat].imagery_resolutions[findProperty("max_zoom_level", url_parameters.sat)].split(" "),
        max_known_res_float = parseFloat(split_max_res[0]),
        zoom_res_km = (max_known_res_float / Math.pow(2, i - max_zoom_level)).toFixed(2) + " " + split_max_res[1];
    $("#custom-menu").append('<li data-action="' + i + '">' + zoom_res_km + "</li>")
}
$("#custom-menu li").click(function () {
    if (null != $(this).attr("data-action")) {
        var e;
        e = parseInt($(this).attr("data-action"));
        var t = convertPageXYToImageXY(right_click_x, right_click_y),
            r = t.x,
            a = t.y;
        url_parameters.x = r, url_parameters.y = a, updateURL(), zoomToPoint(r, a, e), $("#custom-menu").hide(100)
    }
}), loadImagery(), current_zoom_level = url_parameters.z, url_parameters.refresh && (auto_refresh_on_load = 1), opacities_on_load = 1, -1 != url_parameters.slider && (slider_on_load = 1), 1 == url_parameters.mouse_draw && (mouse_draw_on_load = 1), 0 != url_parameters.angle && (rotate_on_load = 1), url_parameters.q && (query_on_load = 1);
...
$("#zoom_holder").css({
    ...
    var r = !1;
    $.each(url_parameters.p, function (t, a) {
        a == e && (r = !0)
...
function calculateFollowSlope(e, t, r, a) {
    return (t - a) / (e - r)
}
...
function calculateFollowCoordinates(e, t, r, a, o, l) {
    var s = [],
        n = calculateFollowStep(e, r, o),
        c = calculateFollowSlope(e, t, r, a),
        u = t - c * e;
    if (e <= r)
...
function drawFollowVector() {
    ...
    var e = $("#followGraphicsWrapper"),
        ...
        a = getOrderedFollowValues(url_parameters.follow_y),
        o = convertBigPixelsToScreenPixels(r.followValues[0]),
        l = convertBigPixelsToScreenPixels(a.followValues[0]),
        s = convertBigPixelsToScreenPixels(r.followValues[1]),
        i = convertBigPixelsToScreenPixels(a.followValues[1]);
    $(".followBox").remove(), displayFollowBox(o, l, 0, r.imageNumbers[0]), displayFollowBox(s, i, 1, r.imageNumbers[1]);
    var n, c, u, p, d = calculateFirstLastImagePosition(o, l, s, i, r.imageNumbers[0], r.imageNumbers[1], t);
...
}), $("#timeStepSelectorChange").selectmenu("refresh"), $.each(json.draw_colors, function (e, t) {
    $("#drawColor").append("<option value='" + t + "' " + (t == "#" + url_parameters.draw_color ? "selected" : "") + ">" + e + "</option>")
}), draw_color = "#" + url_parameters.draw_color, $("#drawColor-button").css("background-color", draw_color), $("#drawColor").selectmenu("refresh"), $.each(json.draw_widths, function (e, t) {
    $("#drawWidth").append("<option value='" + t + "' " + (t == url_parameters.draw_width ? "selected" : "") + ">" + t + "</option>")
}), draw_width = url_parameters.draw_width, $("#drawWidth").selectmenu("refresh");
var getTextHeight = function (e) {
    var t = $("<span>Hg</span>").css({
        ...
        a = $("<div></div>");
    a.append(t, r), $("body").append(a);
    try {
        var o = {};
        r.css({
            verticalAlign: "baseline"
        }), o.ascent = r.offset().top - t.offset().top, r.css({
            verticalAlign: "bottom"
        }), o.height = r.offset().top - t.offset().top, o.descent = o.height - o.ascent
    } finally {
        a.remove()
    }
    return o
...
function drawTextOnBackground(e, t, r, a, o, l, s, i, n, c) {
    i = defaultFor(i, !1), n = defaultFor(n, "left"), c = defaultFor(c, 5);
    var u = getTextHeight(r).height;
    e.font = r;
    var p = e.measureText(t).width;
    "left" == n ? l = 0 + c : "center" == n && (l -= p / 2), "bottom" == i && (s = e.canvas.height - u - c), e.textBaseline = "top", e.fillStyle = o;
    var d = {
        width: p + 2 * c,
        height: u + 2 * c
    };
    return e.fillRect(l - c, s - c, d.width, d.height), e.fillStyle = a, e.fillText(t, l, s), d
}
...
function stitchTiles(e) {
    ...
    e.forEach(function (c, u) {
        ...
        l[p.timestamp] || 100 == p.productOrder || (l[p.timestamp] = document.createElement("canvas"), l[p.timestamp].width = i, l[p.timestamp].height = n, s[p.timestamp] = l[p.timestamp].getContext("2d")), e[u].tileNumber = p.tileNumber, e[u].timestamp = p.timestamp, e[u].productName = p.productName, e[u].productOrder = p.productOrder;
        var d = p.tileNumber[1],
            m = p.tileNumber[2];
        null == t && (t = d, r = d, a = m, o = m), t > d && (t = d), r < d && (r = d), a > m && (a = m), o < m && (o = m)
    }), Object.keys(s).forEach(function (e, t) {
        s[e].globalAlpha = 1, s[e].fillStyle = "black", s[e].fillRect(0, 0, i, n)
    }), (e = e.sort(function (e, t) {
        return e.productOrder - t.productOrder
    })).forEach(function (e, t) {
        var r = tile_size * Math.pow(2, current_zoom_level - e.tileNumber[0]),
            a = r * e.tileNumber[2] + $zoom_holder.offset().left,
            o = r * e.tileNumber[1] + $zoom_holder.offset().top;
        100 == e.productOrder ? Object.keys(s).forEach(function (t, l) {
            s[t].globalAlpha = 1, s[t].drawImage(e.data, a, o, r, r)
        }) : (s[e.timestamp].globalAlpha = all_tiles[e.productOrder][5], s[e.timestamp].drawImage(e.data, a, o, r, r))
    });
    var c = 0,
        u = 0,
        p = 0,
    ...
    return Object.keys(s).forEach(function (e, t) {
        var r = drawTextOnBackground(s[e], convertTimestampToDisplayTime(e), "bold 16px sans-serif", "black", "white", 0, 0, "bottom", "left"); - 1 == $("#colorBar1").prop("src").indexOf("/images/transparent_pixel.png") && (p = i - r.width, d = p * (u / c), s[e].drawImage(m[0], r.width, n - u, p, d)), $("#canvas_wrapper").length && s[e].drawImage(document.getElementById("drawingCanvas"), $("#canvas_wrapper").offset().left, $("#canvas_wrapper").offset().top, $("#canvas_wrapper").width(), $("#canvas_wrapper").height()), s[e].drawImage(document.getElementById("rammbLogo"), i - 80 - 10, n - 80 - 6 - d, 80, 80), s[e].drawImage(document.getElementById("ciraLogo"), i - 110 - 90, n - 46 - 6 - d, 110, 46)
    }), l
}

function parseUrlForTileInfo(e) {
    for (var t = /.*\/([^\/]*)\/(\d{14})\/(\d{2})\/(\d{3})_(\d{3}).*/.exec(e), r = 100, a = 0; a < all_tiles.length; a++)
        if (-1 != all_tiles[a][1].search(t[1])) {
            r = a;
            break
        } return {
        productName: t[1],
...
function getDownloadFilename(e, t) {
    ...
    }), a = e.length > 1 ? e[0].toString() + "-" + e[e.length - 1].toString() : e[0].toString(), "cira-rammb-slider---" + url_parameters.sat + "---" + url_parameters.sec + r + "---" + a + "." + t
}

function displayAnimatedImage(e, t, r) {
    var a = getDownloadFilename(t, r);
    $("#animatedGifWrapper").append("<p>Suggested file name: " + a + "</p>"), printImageSize(e), $("#animatedGifWrapper").append("<a id='imageDownload_" + t[0] + "' href='" + e.src + "' download='" + a + "'></a>"), $("#imageDownload_" + t[0]).append(e)
}

function gifshotWrapper(e, t, r, a) {
    gifshot.createGIF({
        images: e,
        gifWidth: r,
        gifHeight: a,
        ...
        if (!e.error) {
            ...
            a.src = r, $("#animatedGifWrapper").empty(), displayAnimatedImage(a, t, "gif")
        }
    })
}
    ...
    for (var a = 0; a < all_tiles.length; a++)
        for (var o = 0; o < r.length; o++)
            for (var l = 0; l < tiles_in_view.length; l++) {
                var s = tiles_in_view[l][0],
                    i = tiles_in_view[l][1],
                    n = tiles_in_view[l][2];
                current_zoom_level > all_tiles[a][0].length - 1 && (s = all_tiles[a][0].length - 1, i = translateTileNumber(i, current_zoom_level, s), n = translateTileNumber(n, current_zoom_level, s));
                var c = server_root + r[o].toString().slice(0, 8) + "/" + url_parameters.sat + "---" + url_parameters.sec + "/" + url_parameters.p[a] + "/" + r[o] + "/" + leadingZeros(s, 2) + "/" + leadingZeros(i, 3) + "_" + leadingZeros(n, 3) + all_tiles[a][2]; - 1 == $.inArray(c, t) && t.push(c)
            }
    $.each(map_lat_lon_tiles, function (e, a) {
            ...
            for (var o = 0; o < r.length; o++)
                for (var l = 0; l < tiles_in_view.length; l++) {
                    var s = tiles_in_view[l][0],
                        i = tiles_in_view[l][1],
                        n = tiles_in_view[l][2];
                    current_zoom_level > map_lat_lon_tiles[e][0].length - 1 && (s = map_lat_lon_tiles[e][0].length - 1, i = translateTileNumber(i, current_zoom_level, s), n = translateTileNumber(n, current_zoom_level, s));
                    var c = map_lat_lon_tiles[e][1] + map_lat_lon_tiles[e][3][0].toString() + "/" + leadingZeros(s, 2) + "/" + leadingZeros(i, 3) + "_" + leadingZeros(n, 3) + map_lat_lon_tiles[e][2]; - 1 == $.inArray(c, t) && t.push(c)
                }
        ...
        if ("canvas2apng" == e) {
            ...
            var s = document.getElementById("canvas2apngCanvas");
            ...
            Object.keys(l).sort().forEach(function (e, t) {
                i.clearRect(0, 0, l[e].width, l[e].height), i.drawImage(l[e], 0, 0), t == c - 1 && n.setDelay(url_parameters.speed / 10 * 3), n.addFrame(l[e].getContext("2d"))
            }), n.finish(), base64Out = bytesToBase64(n.stream().bin);
            var u = document.createElement("img");
            u.src = "data:image/png;base64," + base64Out, u.style.width = s.width, u.style.height = s.height, $("#progressbar").progressbar("option", "value", 100), $("#animatedGifWrapper").empty(), displayAnimatedImage(u, r, "png")
        } else if ("gifshot" == e) {
            var p = [];
            Object.keys(l).sort().forEach(function (e, t) {
                p.push({
...
}), stopLoopShowSpinner(), setFollowVectors(), 1 == url_parameters.follow_feature && followXVector && followYVector && ($("#followFeature").prop("checked", !0).checkboxradio("refresh"), $("#followHideShow").prop("disabled", !1).checkboxradio("refresh"), $("#followClear").prop("disabled", !1).button("refresh")), 1 == url_parameters.follow_hide && $("#followHideShow").prop("checked", !0).checkboxradio("refresh"), "rock" == url_parameters.motion ? (0 != url_parameters.pause && (pause_loop_rock_rev = 1), $("#radioRock").click()) : "rev" == url_parameters.motion && (0 != url_parameters.pause && (pause_loop_rock_rev = 1), $("#radioRev").click()), setArchiveModeState();
var first_page_xy_query = {},
    second_page_xy_query = {},
    first_lat_lon_query = {},
    distance = void 0,
    measuring_length = !1;

function removeAnyQueryDrawings() {
    first_page_xy_query.offsetX && drawQueryDot(first_page_xy_query, !0), second_page_xy_query.offsetX && drawQueryDot(second_page_xy_query, !0), first_page_xy_query.offsetX && second_page_xy_query.offsetX && drawQueryLine(first_page_xy_query, second_page_xy_query, !0)
}

function drawQueryDot(e, t = !1) {
    t ? ctx.clearRect(e.offsetX - 3, e.offsetY - 3, 6, 6) : (ctx.beginPath(), ctx.fillStyle = draw_color, ctx.arc(e.offsetX, e.offsetY, 3, 0, 2 * Math.PI), ctx.fill(), ctx.closePath())
}

function drawQueryLine(e, t, r = !1) {
    if (r) {
        var a = Math.abs(t.offsetX - e.offsetX),
            o = Math.abs(t.offsetY - e.offsetY),
            l = (t.offsetX - e.offsetX) / a,
            s = (t.offsetY - e.offsetY) / o;
        if (a >= o)
            for (var i = 0; i < a; i += 1) {
                var n = e.offsetX + l * i,
                    c = e.offsetY + Math.floor(s * (i / a) * o);
                ctx.clearRect(n - 2, c - 2, 4, 4)
            } else
                for (var u = 0; u < o; u += 1) {
                    c = e.offsetY + s * u, n = e.offsetX + Math.floor(l * (u / o) * a);
                    ctx.clearRect(n - 2, c - 2, 4, 4)
                }
    } else ctx.beginPath(), ctx.moveTo(e.offsetX, e.offsetY), ctx.lineTo(t.offsetX, t.offsetY), ctx.strokeStyle = draw_color, ctx.lineWidth = 2, ctx.stroke(), ctx.closePath()
}

function haversine(e, t) {
    var r = Math.PI / 180,
        a = (t.lat - e.lat) * r,
        o = (t.lon - e.lon) * r,
        l = Math.sin(a / 2) ** 2 + Math.cos(e.lat * r) * Math.cos(t.lat * r) * Math.sin(o / 2) ** 2;
    return 12742 * Math.atan2(Math.sqrt(l), Math.sqrt(1 - l))
}

function createLatLonCopyContent(e, t, r) {
    var a = convertLatLonToString(e, t);
    return "<span id='latLonValString" + r + "'>" + a.lat + " " + a.lon + "</span> <br><button class='copy-lat-lon-string' data-copy-id='latLonValString" + r + "'><i class='las la-copy'></i> Copy</button><br><br><span id='latLonVal" + r + "'>" + e.lat.toFixed(t) + " " + e.lon.toFixed(t) + "</span> <br><button class='copy-lat-lon-num' data-copy-id='latLonVal" + r + "'><i class='las la-copy'></i> Copy</button>"
}
...
function copyText(e) {
    ...
    a.selectNodeContents(t), r.removeAllRanges(), r.addRange(a), document.execCommand("copy"), r.removeAllRanges()
}

function bigPixels2LatLon(e, t) {
    debug_on && console.log("Debugging click x/y:", e, t);
    var r = json.satellites[url_parameters.sat].sectors[url_parameters.sec].lat_lon_query,
        a = r.lon0,
        o = r.sat_alt,
        l = r.max_rad_x,
        s = r.max_rad_y,
        i = r.disk_radius_x_z0 * 2 ** max_zoom_level,
        n = r.disk_radius_y_z0 * 2 ** max_zoom_level,
        c = (e - (tile_size / 2 - r.disk_radius_x_z0) * 2 ** max_zoom_level - i - .5) / i * l,
        u = (t - (tile_size / 2 - r.disk_radius_y_z0) * 2 ** max_zoom_level - n - .5) / n * -1 * s,
        p = Math.sin(c) ** 2 + Math.cos(c) ** 2 * (Math.cos(u) ** 2 + (6378.1 / 6356.8 * Math.sin(u)) ** 2),
        d = -2 * o * Math.cos(c) * Math.cos(u),
        m = (-d - (d ** 2 - 4 * p * (o ** 2 - 6378.1 ** 2)) ** .5) / (2 * p),
        _ = m * Math.cos(c) * Math.cos(u),
        h = m * Math.sin(c),
        f = m * Math.cos(c) * Math.sin(u),
        g = Math.atan(1.0067127124992927 * f / ((o - _) ** 2 + h ** 2) ** .5) * (180 / Math.PI),
        v = a + Math.atan(h / (o - _)) * (180 / Math.PI);
    return {
        lat: g,
        lon: v = v < -180 ? v + 360 : v > 180 ? v - 360 : v
    }
}

function convertLatLonToString(e, t) {
    return lon_ew = Math.abs(e.lon.toFixed(t)) + "°" + (e.lon < 0 ? "W" : "E"), lat_ns = Math.abs(e.lat.toFixed(t)) + "°" + (e.lat < 0 ? "S" : "N"), {
        lat: lat_ns,
        lon: lon_ew
    }
}
...
function updateScaleBars() {
    if (json.satellites[url_parameters.sat].sectors[url_parameters.sec].lat_lon_query) {
        if (current_zoom_level < json.satellites[url_parameters.sat].sectors[url_parameters.sec].lat_lon_query.scale_bar_min_zoom) return $("#queryLatLon").prop("checked") ? ($("#switchUnitsButton").show(), $("#switchUnitsButton").text("Switch to " + (scale_in_miles ? "km" : "mi."))) : $("#switchUnitsButton").hide(), void $("#scaleBarX, #scaleBarY").hide();
        var e = url_parameters.x,
            t = url_parameters.y,
            r = $("#scaleBarX").width() * Math.pow(2, max_zoom_level - current_zoom_level),
            a = (i = bigPixels2LatLon(e - r / 2, t)).lat,
            o = i.lon,
            l = bigPixels2LatLon(e + r / 2, t).lon,
            s = 111 * Math.abs(l - o) * Math.cos(a * Math.PI / 180) * (scale_in_miles ? .621371 : 1);
        $("#scaleBarX").html(s.toFixed(1) + (scale_in_miles ? " mi." : " km"));
        (i = bigPixels2LatLon(e, t - r / 2)).lon;
        var i, n = i.lat,
            c = bigPixels2LatLon(e, t + r / 2).lat,
            u = 111 * Math.abs(c - n) * (scale_in_miles ? .621371 : 1);
        $("#scaleBarY").html(u.toFixed(1) + (scale_in_miles ? " mi." : " km")), Number.isNaN(s + u) ? $("#switchUnitsButton, #scaleBarX, #scaleBarY").hide() : ($("#switchUnitsButton").text("Switch to " + (scale_in_miles ? "km" : "mi.")), $("#switchUnitsButton, #scaleBarX, #scaleBarY").show())
    } else $("#switchUnitsButton, #scaleBarX, #scaleBarY").hide()
}
$("#zoom_holder").on("click", function (e) {
    var t = $("#mouseDrawOn").prop("checked") && $("#mouseDrawAddText").hasClass("draw-active");
    if (t || $("#queryLatLon").prop("checked"))
        if (t) {
            var r = prompt("Please enter the text you'd like to add");
            if (r) {
                var a = 6 * draw_width;
                ctx.font = a + "px Arial";
                var o = ctx.measureText(r);
                ctx.fillStyle = draw_color, ctx.fillText(r, e.offsetX, e.offsetY + .5 * (o.actualBoundingBoxAscent - o.actualBoundingBoxDescent)), a > 18 && (ctx.lineWidth = 1, ctx.strokeStyle = "black", ctx.strokeText(r, e.offsetX, e.offsetY + .5 * (o.actualBoundingBoxAscent - o.actualBoundingBoxDescent)))
            }
        } else if ($("#queryLatLon").prop("checked")) {
        if (!json.satellites[url_parameters.sat].sectors[url_parameters.sec].lat_lon_query) return;
        if (!$.isEmptyObject(xy_at_mouse_down) && (xy_at_mouse_down.offsetX != e.offsetX || xy_at_mouse_down.offsetY != e.offsetY)) return;
        var l = json.satellites[url_parameters.sat].sectors[url_parameters.sec].lat_lon_query,
            s = convertPageXYToImageXY(e.pageX, e.pageY),
            i = bigPixels2LatLon(s.x, s.y),
            n = l.decimal_places;
        isNaN(i.lat) || isNaN(i.lon) ? createTemporaryMessage("Click Out of Bounds", "Oops! The point you clicked was too close to the edge of the disk or in outer space.") : measuring_length ? (measuring_length = !1, drawQueryDot(second_page_xy_query = {
            offsetX: e.offsetX,
            offsetY: e.offsetY
        }), drawQueryLine(first_page_xy_query, second_page_xy_query), distance = haversine(first_lat_lon_query, i) * (scale_in_miles ? .621371 : 1), createTemporaryMessage("2nd Lat/Lon Query", createLatLonCopyContent(i, n, 2)), createTemporaryMessage("Lat/Lon Query", createLatLonCopyContent(first_lat_lon_query, n, 1), !1), createTemporaryMessage("Distance", distance.toFixed(0) + (scale_in_miles ? " mi." : " km"), !1), first_lat_lon_query = {}) : (removeAnyQueryDrawings(), drawQueryDot({
            offsetX: e.offsetX,
            offsetY: e.offsetY
        }), distance = void 0, createTemporaryMessage("Measure Distance From Here", "<button id='measureButton'>Click to Start</button>"), createTemporaryMessage("Lat/Lon Query", createLatLonCopyContent(i, n, 1), !1), $("#measureButton").on("click", function () {
            createTemporaryMessage("Click End Point", "The starting point for this measurement is shown above; please click where you'd like the measurement to end"), createTemporaryMessage("Lat/Lon Query", createLatLonCopyContent(i, n, 1), !1), measuring_length = !0
        }), first_page_xy_query.offsetX = e.offsetX, first_page_xy_query.offsetY = e.offsetY, second_page_xy_query = {}, first_lat_lon_query = i), $(".copy-lat-lon-string").on("click", function () {
            copyText($(this).attr("data-copy-id"))
        }), $(".copy-lat-lon-num").on("click", function () {
            copyText($(this).data("copy-id"))
        })
    }
}), $("#switchUnitsButton").on("click", function () {
    scale_in_miles = !scale_in_miles, updateScaleBars();
    var e = $("p.message-content.message-distance");
    e && (distance *= .621371 ** (scale_in_miles ? 1 : -1), e.html(distance.toFixed(0) + (scale_in_miles ? " mi." : " km")))
});
var temporaryMessageTimeoutId = null,
    temporaryMessageTimeoutLength = 0,
    temporaryMessageTimeoutStartedAt = (new Date).getTime();

function createTemporaryMessage(e, t, r = !0, a = 0, o = 0) {
    $("#messageContainer").stop(), clearTimeout(temporaryMessageTimeoutId), r && closeMessageContainer(0);
    var l = "message-" + e.toLowerCase().replace(/[ \/]/g, "-");
    if ($("#messageContainer .message-container-heading").after("<hr class='message-container-separator message-temporary " + l + "'><h3 class='message-title message-temporary " + l + "'>" + e + "</h3><p class='message-content message-temporary " + l + "'>" + t + "</p>"), $("#messageContainer").show(), 0 != a) {
        var s = a;
        !r && temporaryMessageTimeoutStartedAt && temporaryMessageTimeoutLength && (s += temporaryMessageTimeoutLength - ((new Date).getTime() - temporaryMessageTimeoutStartedAt)), temporaryMessageTimeoutLength = s, temporaryMessageTimeoutStartedAt = (new Date).getTime(), temporaryMessageTimeoutId = setTimeout(function () {
            closeMessageContainer(o)
        }, s)
    }
}